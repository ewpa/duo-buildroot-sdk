int cvi_board_init(void)
{
	...
	// I2C1
	//PINMUX_CONFIG(PAD_MIPIRX1P, IIC1_SDA);   // Duo Pin 14 -- DC/AO
	...
	// SPI
	PINMUX_CONFIG(SD1_CLK, SPI2_SCK);        // Duo Pin  9 -- SCK
	PINMUX_CONFIG(SD1_CMD, SPI2_SDO);        // Duo Pin 10 -- SDA
	PINMUX_CONFIG(SD1_D0, SPI2_SDI);
	PINMUX_CONFIG(SD1_D3, SPI2_CS_X);        // Duo Pin 12 -- CS
